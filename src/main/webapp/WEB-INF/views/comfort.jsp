...
<h3 style="text-align: center"><spring:message code="app.comfort.comforts"/>:</h3>
<table border="1" cellpadding="10" class="table_blur" align="center">
    <tr>
        <td>
            <form action="/admin/comfort/add" method="post">
    ...
    <c:forEach var="comfort" items="${comfort}">
        <tr>
            <td>
                <div class="card" style="width: 80rem;">
                    <div class="card-body">
                        <h5 class="card-title">${comfort.name}</h5>
